...
namespace YTcms.DAL
{
    ...
    public partial class site_oauth
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Dapper.Model.site_oauth model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Dapper.Model.site_oauth model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Dapper.Model.site_oauth GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Dapper.Model.site_oauth model = new Dapper.Model.site_oauth();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = model.GetType().GetProperties();
        ...
        /// 将对象转换实体
        /// </summary>
        public Dapper.Model.site_oauth DataRowToModel(DataRow row)
        {
            Dapper.Model.site_oauth model = new Dapper.Model.site_oauth();
            if (row != null)
            {
