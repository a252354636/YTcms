...
namespace YTcms.DAL
{
    ...
    public partial class mail_template
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Dapper.Model.mail_template model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Dapper.Model.mail_template model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Dapper.Model.mail_template GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Dapper.Model.mail_template model = new Dapper.Model.mail_template();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = model.GetType().GetProperties();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Dapper.Model.mail_template GetModel(string call_index)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Dapper.Model.mail_template model = new Dapper.Model.mail_template();
        ...
        /// 将对象转换实体
        /// </summary>
        public Dapper.Model.mail_template DataRowToModel(DataRow row)
        {
            Dapper.Model.mail_template model = new Dapper.Model.mail_template();
            if (row != null)
            {
