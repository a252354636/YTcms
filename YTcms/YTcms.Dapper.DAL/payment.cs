...
namespace YTcms.DAL
{
    ...
    public partial class payment
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Dapper.Model.payment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Dapper.Model.payment model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Dapper.Model.payment GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder str1 = new StringBuilder();
            Dapper.Model.payment model = new Dapper.Model.payment();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = model.GetType().GetProperties();
        ...
        /// 将对象转换实体
        /// </summary>
        public Dapper.Model.payment DataRowToModel(DataRow row)
        {
            Dapper.Model.payment model = new Dapper.Model.payment();
            if (row != null)
            {
